...
@interface ChooseTableViewCell()<UITextFieldDelegate>
...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        _addButton = [[UIButton alloc]initWithFrame:CGRectMake(MAIN_WIDTH-30, 18, 10, 20)];
        [_addButton setImage:[UIImage imageNamed:@"右箭头.png"] forState:UIControlStateNormal];
