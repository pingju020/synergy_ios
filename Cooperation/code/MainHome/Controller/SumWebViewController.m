...
@interface SumWebViewController ()<UIImagePickerControllerDelegate,UINavigationControllerDelegate,UIScrollViewDelegate,UIGestureRecognizerDelegate>

@end

@implementation SumWebViewController
{
    UIButton* back;
    UIButton* title;
